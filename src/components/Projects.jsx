      ...
      <section id="projects" className="py-20 relative min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white"><span className="text-primary">03.</span> Featured Missions</h2>
            <p className="mt-4 text-slate-600 dark:text-slate-200 font-medium text-lg">Click on a mission card to view classified details.</p>
          </div>
